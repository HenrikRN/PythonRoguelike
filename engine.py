    ...
    while not tcod.console_is_window_closed():
        ...
        for player_turn_result in player_turn_results:
            ...
            if xp:
                ...
                if leveled_up:
                    message_log.add_message(Message('Your battle skills grow stronger! You reached level {0}'.format(player.level.current_level) + '!', tcod.yellow))
                    previous_game_state = game_state
            ...
            if equip:
                ...
                for equip_result in equip_results:
                    ...
                    if dequipped:
                        message_log.add_message(Message('You dequipped the {0}'.format(equipped.name)))
